...
<head>
    ...
    <title>Registrar Entrada - Control Finanzas</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css">
</head>
<body>
<c:set var="menu" value="reg_entrada"/>
<div class="layout">
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="form-card">
                ...
                <form method="post" action="${pageContext.request.contextPath}/entradas"
                      enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="tipoEntrada">Tipo de Entrada</label>
                        <input type="text" id="tipoEntrada" name="tipoEntrada"
                               placeholder="Ej: Sueldo, Remesa, Venta..."
                               value="${param.tipoEntrada}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="factura">Factura (imagen opcional)</label>
